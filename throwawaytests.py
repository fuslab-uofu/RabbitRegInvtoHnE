...
day3_dir = '/System/Volumes/Data/ceph/hifu/users/jbonaventura/RabbitRegistrationProj/RabbitData/R23-055/InVivo_MR/InVMRDataSets/Day3'
...
# transform_folder = os.path.join(os.path.dirname(day3_dir), 'Transforms')
# orig_vol = '/ceph/hifu/users/jbonaventura/RabbitRegistrationProj/RabbitData/R23-055/InVivo_MR/InVMRDataSets/Day0/T1wCE.nii.gz'
# src_vol = fixed_vols[0]
#
